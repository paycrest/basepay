...
export default function Dashboard() {
   ...
   const [tsxHistoryResponse, setTxHistoryResponse] = useState<
      TransactionsListResponse
   >();
   ...
   useEffect(() => {
      ...
      const getTransactionHistory = async () => {
         if (!ready || !linkedAddress || !isAddressLinked || !privyIdToken)
            return;
                     ...
                     <AnimatedItem className="relative rounded-2xl p-3 bg-gray-50 border border-border-light space-y-4 overflow-hidden">
                        ...
                        <div className="space-y-2 relative">
                           ...
                           <p className="text-text-secondary text-sm font-normal">
                              Claim your unique digital identity. Simple,
                              memorable, and all yours.
                           </p>
                        </div>
                        <Link
                           target="_blank"
