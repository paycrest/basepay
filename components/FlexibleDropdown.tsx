			...
			{isOpen && (
				<motion.div
					...
					className={classNames(
						"absolute right-0 z-10 mt-2 max-h-52 max-w-full overflow-y-auto rounded-xl bg-gray-50 shadow-xl",
						className ?? "min-w-40",
					)}
				>
						...
						{data?.map((item) => (
							<li key={item.name}>
								<button
									...
									className={classNames(
										"flex items-center justify-between gap-2 px-3 py-2 transition-all hover:bg-gray-200 w-full",
