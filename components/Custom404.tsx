...
export const Custom404 = ({ address }: { address: string }) => {
						...
						<div className="border-border-light border rounded-3xl bg-gray-50">
							...
							<div className="px-4 py-3">
								<p className="text-text-secondary text-sm sm:text-lg">
									Basepay link lets you receive direct fiat payments with crypto
									through a simple interface. Just like a bank transfer powered
									by digital assets - no P2P required.
								</p>
							</div>
						</div>
